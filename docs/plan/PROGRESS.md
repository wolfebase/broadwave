...
## Resume here
- Current task: **PB3b** done this round. Next is **PB5** (GPU decode, jellyfin-ffmpeg, VMAF bitrates). App Review unchanged (WAITING_FOR_REVIEW, iOS and tvOS, checked 2026-09-25 00:00 UTC).
