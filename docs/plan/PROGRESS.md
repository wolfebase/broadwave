...
## Resume here
- Current task: **C7b**. PB16 is done: a second same-language complete main stays Main, and staging 41.1 passthrough is ac3 6ch 5.1. App Review unchanged: tvOS 1.0 REJECTED (Guideline 2.1), iOS 1.0 WAITING_FOR_REVIEW, checked 2026-09-25. The owner sends the reply. Production is `v0.7.1`. Staging on `:8490` is this PB16 tree. Next recording Jeopardy 2026-09-25 20:00 UTC (pad 1 min). Tuners released.
