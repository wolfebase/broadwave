...
## Resume here
- Current task: **PB8** stream panel. App Review unchanged (WAITING_FOR_REVIEW, iOS and tvOS, checked 2026-09-25 02:40 UTC). Production is `ghcr.io/wolfebase/broadwave:0.6.0`. Staging is the PB7 binary (`v0.6.0-15-g29ff7be-dirty`) on `:8490`. Tuners free after PB7b; next recording Jeopardy 2026-09-25 20:00 UTC.
