...
## Resume here
- Current task: **MV2** (tvOS focus and remote). HW1 review fix is in this commit: a control tune streams, and `none` does not cancel the next tune. App Review unchanged at 2026-09-25 15:02Z: tvOS 1.0 REJECTED (Guideline 2.1), iOS 1.0 WAITING_FOR_REVIEW. The owner sends the reply.
